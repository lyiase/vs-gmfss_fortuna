...
class GMFSS(nn.Module):
    ...
    def forward(self, img0, img1, timestep):
        F1t, F2t, Z1t, Z2t, feat11, feat12, feat13, feat21, feat22, feat23 = self.feature_and_flow_extraction(img0, img1, timestep)
